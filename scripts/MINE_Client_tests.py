...
services = mineDatabaseServices(url='http://bio-data-1.mcs.anl.gov/services/mine-database', user_id='jjeffryes', password="!#sd8gNakW5Y*d3p")
test_db = 'EcoCycexp2'
...
def test_get_ops():
    meh = services.get_ops(test_db, ['2.4.1.a'])[0]
