...
test_db = "KEGGexp"
test_unk = open("/Users/JGJeffryes/Documents/Research/Scripts/Python/Database Scripts/Batch Adduct Query/Knowns.txt").read()
result = services.batch_ms_adduct_search(test_db, pos_unks, "csv", 0.005, ['M+H'], [], False, True, False)
"""
