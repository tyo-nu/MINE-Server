...
class mineDatabaseServices(object):
    ...
    def model_search(self, query):
        ...
        arg_hash = {'method': 'mineDatabaseServices.model_search',
                    'params': [query],
                    'version': '1.1',
    ...
    def get_comps(self, db, ids):
        ...
        arg_hash = {'method': 'mineDatabaseServices.get_comps',
                    'params': [db, ids],
                    'version': '1.1',
                    'id': str(random.random())[2:]
                    }
    ...
    def get_rxns(self, db, ids):
        ...
        arg_hash = {'method': 'mineDatabaseServices.get_rxns',
                    'params': [db, ids],
                    'version': '1.1',
                    'id': str(random.random())[2:]
                    }
    ...
    def get_models(self):
        ...
        arg_hash = {'method': 'mineDatabaseServices.get_models',
                    'params': [],
                    'version': '1.1',
                    'id': str(random.random())[2:]
                    }
    ...
    def batch_ms_adduct_search(self, db, text, text_type, tolerance, adduct_list, models, ppm, charge, halogens):
        ...
        arg_hash = {'method': 'mineDatabaseServices.batch_ms_adduct_search',
                    'params': [db, text, text_type, tolerance, adduct_list, models, ppm, charge, halogens],
                    'version': '1.1',
                    'id': str(random.random())[2:]
                    }
