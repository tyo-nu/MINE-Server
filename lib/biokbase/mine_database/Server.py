...
from biokbase.mine_database.Impl import mineDatabaseServices
impl_mineDatabaseServices = mineDatabaseServices(config)
...
class Application(object):
    ...
    def __init__(self):
        ...
        self.rpc_service.add(impl_mineDatabaseServices.similarity_search,
                             ...
                             types=[basestring, basestring, float, basestring])
