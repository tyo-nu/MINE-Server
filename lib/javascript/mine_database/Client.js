...
function mineDatabaseServices(url, auth, auth_cb) {
    ...
    this.database_query = function (db, query, _callback, _errorCallback) {
    return json_call_ajax("mineDatabaseServices.database_query",
        [db, query], 1, _callback, _errorCallback);
};

    this.database_query_async = function (db, query, _callback, _error_callback) {
        deprecationWarning();
        return json_call_ajax("mineDatabaseServices.database_query", [db, query], 1, _callback, _error_callback);
    };
