...
function mineDatabaseServices(url, auth, auth_cb) {
    ...
    this.similarity_search = function (db, smiles, min_tc, fp_type, _callback, _errorCallback) {
    return json_call_ajax("mineDatabaseServices.similarity_search",
        [db, smiles, min_tc, fp_type], 1, _callback, _errorCallback);
};

    this.similarity_search_async = function (db, smiles, min_tc, fp_type, _callback, _error_callback) {
        deprecationWarning();
        return json_call_ajax("mineDatabaseServices.similarity_search", [db, smiles, min_tc, fp_type], 1, _callback, _error_callback);
    };

    this.substructure_search = function (db, smiles, _callback, _errorCallback) {
    return json_call_ajax("mineDatabaseServices.substructure_search",
        [db, smiles], 1, _callback, _errorCallback);
};

    this.substructure_search_async = function (db, smiles, _callback, _error_callback) {
        deprecationWarning();
        return json_call_ajax("mineDatabaseServices.substructure_search", [db, smiles], 1, _callback, _error_callback);
    };
