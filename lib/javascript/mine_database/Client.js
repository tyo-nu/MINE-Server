...
function mineDatabaseServices(url, auth, auth_cb) {
    ...
    this.get_rxns = function (db, operator_names, _callback, _errorCallback) {
    return json_call_ajax("mineDatabaseServices.get_rxns",
        [db, operator_names], 1, _callback, _errorCallback);
};

    this.get_rxns_async = function (db, operator_names, _callback, _error_callback) {
        deprecationWarning();
        return json_call_ajax("mineDatabaseServices.get_rxns", [db, operator_names], 1, _callback, _error_callback);
    };
