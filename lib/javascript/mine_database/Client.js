...
function mineDatabaseServices(url, auth, auth_cb) {
    ...
    this.get_ids = function (db, collection, _callback, _errorCallback) {
    return json_call_ajax("mineDatabaseServices.get_ids",
        [db, collection], 1, _callback, _errorCallback);
};

    this.get_ids_async = function (db, collection, _callback, _error_callback) {
        deprecationWarning();
        return json_call_ajax("mineDatabaseServices.get_ids", [db, collection], 1, _callback, _error_callback);
    };
