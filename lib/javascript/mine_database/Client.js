...
function mineDatabaseServices(url, auth, auth_cb) {
    ...
    this.similarity_search = function (db, smiles, min_tc, fp_type, limit, _callback, _errorCallback) {
    return json_call_ajax("mineDatabaseServices.similarity_search",
        [db, smiles, min_tc, fp_type, limit], 1, _callback, _errorCallback);
};

    this.similarity_search_async = function (db, smiles, min_tc, fp_type, limit, _callback, _error_callback) {
        deprecationWarning();
        return json_call_ajax("mineDatabaseServices.similarity_search", [db, smiles, min_tc, fp_type, limit], 1, _callback, _error_callback);
    };

    this.substructure_search = function (db, smiles, limit, _callback, _errorCallback) {
    return json_call_ajax("mineDatabaseServices.substructure_search",
        [db, smiles, limit], 1, _callback, _errorCallback);
};

    this.substructure_search_async = function (db, smiles, limit, _callback, _error_callback) {
        deprecationWarning();
        return json_call_ajax("mineDatabaseServices.substructure_search", [db, smiles, limit], 1, _callback, _error_callback);
    };

    this.database_query = function (db, field, value, regex, _callback, _errorCallback) {
    return json_call_ajax("mineDatabaseServices.database_query",
        [db, field, value, regex], 1, _callback, _errorCallback);
};

    this.database_query_async = function (db, field, value, regex, _callback, _error_callback) {
        deprecationWarning();
        return json_call_ajax("mineDatabaseServices.database_query", [db, field, value, regex], 1, _callback, _error_callback);
    };
    ...
    this.adduct_db_search = function (db, mz, tolerance, adduct_list, models, ppm, charge, halogens, _callback, _errorCallback) {
    return json_call_ajax("mineDatabaseServices.adduct_db_search",
        [db, mz, tolerance, adduct_list, models, ppm, charge, halogens], 1, _callback, _errorCallback);
};

    this.adduct_db_search_async = function (db, mz, tolerance, adduct_list, models, ppm, charge, halogens, _callback, _error_callback) {
        deprecationWarning();
        return json_call_ajax("mineDatabaseServices.adduct_db_search", [db, mz, tolerance, adduct_list, models, ppm, charge, halogens], 1, _callback, _error_callback);
    };
