...
function mineDatabaseServices(url, auth, auth_cb) {
    ...
    this.quick_search = function (db, query, parent_filter, _callback, _errorCallback) {
    return json_call_ajax("mineDatabaseServices.quick_search",
        [db, query, parent_filter], 1, _callback, _errorCallback);
};

    this.quick_search_async = function (db, query, parent_filter, _callback, _error_callback) {
        deprecationWarning();
        return json_call_ajax("mineDatabaseServices.quick_search", [db, query, parent_filter], 1, _callback, _error_callback);
    };

    this.similarity_search = function (db, comp_structure, min_tc, fp_type, limit, parent_filter, _callback, _errorCallback) {
    return json_call_ajax("mineDatabaseServices.similarity_search",
        [db, comp_structure, min_tc, fp_type, limit, parent_filter], 1, _callback, _errorCallback);
};

    this.similarity_search_async = function (db, comp_structure, min_tc, fp_type, limit, parent_filter, _callback, _error_callback) {
        deprecationWarning();
        return json_call_ajax("mineDatabaseServices.similarity_search", [db, comp_structure, min_tc, fp_type, limit, parent_filter], 1, _callback, _error_callback);
    };

    this.structure_search = function (db, input_format, comp_structure, parent_filter, _callback, _errorCallback) {
    return json_call_ajax("mineDatabaseServices.structure_search",
        [db, input_format, comp_structure, parent_filter], 1, _callback, _errorCallback);
};

    this.structure_search_async = function (db, input_format, comp_structure, parent_filter, _callback, _error_callback) {
        deprecationWarning();
        return json_call_ajax("mineDatabaseServices.structure_search", [db, input_format, comp_structure, parent_filter], 1, _callback, _error_callback);
    };
    ...
    return json_call_ajax("mineDatabaseServices.substructure_search",
        [db, substructure, limit, parent_filter], 1, _callback, _errorCallback);
};

    this.substructure_search_async = function (db, substructure, limit, parent_filter, _callback, _error_callback) {
        deprecationWarning();
        return json_call_ajax("mineDatabaseServices.substructure_search", [db, substructure, limit, parent_filter], 1, _callback, _error_callback);
    };

    this.database_query = function (db, mongo_query, parent_filter, _callback, _errorCallback) {
    return json_call_ajax("mineDatabaseServices.database_query",
        [db, mongo_query, parent_filter], 1, _callback, _errorCallback);
};

    this.database_query_async = function (db, mongo_query, parent_filter, _callback, _error_callback) {
        deprecationWarning();
        return json_call_ajax("mineDatabaseServices.database_query", [db, mongo_query, parent_filter], 1, _callback, _error_callback);
    };
    ...
    this.spectra_download = function (db, mongo_query, parent_filter, putative, spec_type, _callback, _errorCallback) {
    return json_call_ajax("mineDatabaseServices.spectra_download",
        [db, mongo_query, parent_filter, putative, spec_type], 1, _callback, _errorCallback);
};

    this.spectra_download_async = function (db, mongo_query, parent_filter, putative, spec_type, _callback, _error_callback) {
        deprecationWarning();
        return json_call_ajax("mineDatabaseServices.spectra_download", [db, mongo_query, parent_filter, putative, spec_type], 1, _callback, _error_callback);
    };
